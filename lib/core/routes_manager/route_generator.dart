...
import 'package:acm_online/feature/app/category/presentation/cubit/category/category_cubit.dart';
...
import '../../feature/app/leader_board/presentation/page/leader_board_screen.dart';
  ...
  static Route<dynamic> generateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RoutesNames.quizScreen:
        ...
        return MaterialPageRoute(
          builder: (_) => QuizLevelScreen(subCategoryId: args),
        );
